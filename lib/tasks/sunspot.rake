namespace :formaggio do
  namespace :sunspot do
    ...
    #
    # $ rake formaggio:sunspot:index                # reindex all models
    # $ rake formaggio:sunspot:index[1000]          # reindex in batches of 1000
    # $ rake formaggio:sunspot:index[false]         # reindex without batching
    # $ rake formaggio:sunspot:index[,Post]         # reindex only the Post model
    # $ rake formaggio:sunspot:index[1000,Post]     # reindex only the Post model in
    #                                       # batchs of 1000
